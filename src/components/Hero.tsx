  ...
  return (
    <section ref={ref} className="relative h-screen">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(100deg, rgba(47,58,42,0.72) 0%, rgba(47,58,42,0.5) 30%, rgba(47,58,42,0.1) 62%, transparent 78%)",
        }}
      />
      <div
        className="pointer-events-none fixed inset-x-0 bottom-0 z-[1] h-48 w-full"
        style={{ background: "linear-gradient(to top, rgba(47,58,42,0.55), transparent)" }}
      />
      ...
      >
        <div className="max-w-[720px]">
          <p className="mb-7 text-[14px] tracking-[0.04em] text-white/70">
            north leather — full-grain, hand-stitched
          </p>
          <h1 className="font-display text-[15vw] font-light lowercase leading-[1.05] text-white sm:text-[9vw] md:text-[6.5vw] lg:text-[5.5rem]">
            {LINES.map((line, li) => (
          ...
          <motion.p
            ...
            className="mt-7 max-w-md text-[16px] leading-[1.7] text-white/85"
          >
      ...
      <div className="absolute right-6 top-28 z-10 hidden max-w-[220px] text-right text-[13px] leading-[1.7] tracking-[0.02em] text-white/50 md:block md:right-10">
        <p>full-grain hide</p>
      ...
      >
        <div className="flex flex-col items-center gap-2 text-white/60">
          <span className="text-[12px] tracking-[0.1em]">scroll</span>
          <span className="h-8 w-px rounded-full bg-white/40" />
        </div>
      </motion.div>
    </section>
  );
